...
{
    public float[] ValuesTimeline = new float[49];
    ...
    public override void Read(BinaryObjectReader reader)
    {
        reader.ReadArray<float>(49, ValuesTimeline);
    }

    public override void Write(BinaryObjectWriter writer)
    {
        writer.WriteArrayFixedLength(ValuesTimeline, 49);
    }
}
...
public class DVDOFParameter : DVParameter
{
    public int Field00 { get; set; }
    ...
    public DVDOFParameter() { }
    public DVDOFParameter(BinaryObjectReader reader)
        => Read(reader);
