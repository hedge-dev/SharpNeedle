...
public static class MathHelper
{
    ...
    {
        return vector.X > vector.Y && vector.X > vector.Z ? 0 : vector.Y > vector.Z ? 1 : 2;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static int MaxAxis(this Vector4 vector)
    {
        return vector.X > vector.Y && vector.X > vector.Z && vector.X > vector.W ? 0 :
    ...
    {
        return MathF.Max(vector.X, MathF.Max(vector.Y, MathF.Min(vector.Z, vector.W)));
    }
    ...
    {
        return MathF.Min(vector.X, MathF.Min(vector.Y, MathF.Min(vector.Z, vector.W)));
    }
